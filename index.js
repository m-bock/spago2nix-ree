                              ...
                              return Control_Bind.bind(Data_Either.bindEither)(gDecodeJson(dictGDecodeJson)(object)(Type_Data_RowList.RLProxy.value))(function (v1) {
                                  ...
                                  if (v2 instanceof Data_Maybe.Just) {
                                      return Control_Bind.bind(Data_Either.bindEither)(decodeJson(dictDecodeJson)(v2.value0))(function (v3) {
                                          return Data_Either.Right.create(Record.insert(dictIsSymbol)()()(Data_Symbol.SProxy.value)(v3)(v1));
                                      });
                                  };
                                  if (v2 instanceof Data_Maybe.Nothing) {
...
(function($PS) {
  ...
  var writeTextFile = function (path) {
      return function (content) {
          return Control_Monad_Except_Trans.withExceptT(Effect_Aff.functorAff)(Data_Function["const"]([ "Cannot write to file " + (tick(path) + ".") ]))(Control_Monad_Except_Trans.ExceptT(Control_Monad_Error_Class["try"](Effect_Aff.monadErrorAff)(Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(path)(content))));
      };
  };
  var printNixExpr = function (v) {
      return Partial_Unsafe.unsafeCrashWith("TODO: printNixExpr");
  };
  var printErrorStack = function (errorStack) {
      return Data_String_Common.joinWith("\x0a\x0a")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "Something went wrong along the way..." ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(errorStack)(function (v) {
          return " - " + v;
      })));
  };
  var parseEnvString = Data_Either.Right.create;
  var parseEnvBool = function (v) {
      if (v === "true") {
      ...
      return new Data_Either.Left([ "Invalid boolean." ]);
  };
  var parseEnvDebug = function (obj) {
      return Data_Either.either(Data_Function["const"](false))(Control_Category.identity(Control_Category.categoryFn))(Control_Bind.bind(Data_Either.bindEither)(Data_Either.note([  ])(Foreign_Object.lookup("DEBUG")(obj)))(parseEnvBool));
  };
  var parseCliArgs = Control_Apply.apply(Options_Applicative_Types.parserApply)(Data_Functor.map(Options_Applicative_Types.parserFunctor)(function (spagoConfig) {
      return function (target) {
          return {
              spagoConfig: spagoConfig,
              target: target
          };
      };
  })(Options_Applicative_Builder.strOption(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("spagoConfig"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("SPAGO_CONFIG"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.help("Path to spago config"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.showDefault(Data_Show.showString))(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)("spago.dhall"))))))))(Options_Applicative_Builder.strOption(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("target"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("TARGET"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.help("Path to target file"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.showDefault(Data_Show.showString))(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)("spago.nix")))))));
  var opts = Options_Applicative_Builder.info(Options_Applicative_Internal_Utils.apApplyFlipped(Options_Applicative_Types.parserApply)(parseCliArgs)(Options_Applicative_Extra.helper))(Data_Semigroup.append(Options_Applicative_Builder.infoModSemigroup)(Options_Applicative_Builder.fullDesc)(Data_Semigroup.append(Options_Applicative_Builder.infoModSemigroup)(Options_Applicative_Builder.progDesc(""))(Options_Applicative_Builder.header("spago.dhall2nix - Generate nix expressions from spago config files"))));
  var nativeErrorToStack = function (debug) {
      return function (unknownError) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "Unknown error." ])(Data_Monoid.guard(Data_Monoid.monoidArray)(debug)([ Data_Show.show(Effect_Exception.showError)(unknownError) ]));
      };
  };
  var lookupOptional = function (key) {
      return function (def) {
          return function (cont) {
              return function (obj) {
                  var v = Foreign_Object.lookup(key)(obj);
                  if (v instanceof Data_Maybe.Just) {
                      return Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Array.cons("Read " + (tick(key) + ".")))(cont(v.value0));
                  };
                  if (v instanceof Data_Maybe.Nothing) {
                      return new Data_Either.Right(def);
                  };
                  throw new Error("Failed pattern match at Main (line 87, column 35 - line 89, column 23): " + [ v.constructor.name ]);
              };
          };
      };
  };
  var parseEnv = function (obj) {
      ...
      })(lookupOptional("DEBUG")(false)(parseEnvBool)(obj)))(lookupOptional("DHALL_TO_JSON")("dhall-to-json")(parseEnvString)(obj)))(lookupOptional("NIX_FORMAT")("nixfmt")(parseEnvString)(obj)))(lookupOptional("NIX_PREFETCH_GIT")("nix-prefetch-git")(parseEnvString)(obj));
  };
  var lookup$prime = function (key) {
      return function (obj) {
          return Data_Either.note([ "Expected " + (tick(key) + ".") ])(Foreign_Object.lookup(key)(obj));
      };
  };
  var getEnv = Control_Monad_Except_Trans.ExceptT(Data_Functor.mapFlipped(Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Process.getEnv))((function () {
      var $54 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Array.cons("Read Environment variables."));
      return function ($55) {
          return $54(parseEnv($55));
      };
  })()));
  var getCliArgs = Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(Effect_Aff.monadAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Options_Applicative_Extra.execParser(opts)));
  var generateNix = function (v) {
      return Partial_Unsafe.unsafeCrashWith("TODO: generateNix");
  };
  var dhallToJson = function (cmd) {
      return function (dhallCode) {
          return Control_Monad_Except_Trans.ExceptT(Data_Functor.mapFlipped(Effect_Aff.functorAff)(Data_Functor.mapFlipped(Effect_Aff.functorAff)(Control_Monad_Error_Class["try"](Effect_Aff.monadErrorAff)(Sunde.spawn({
              cmd: cmd,
              args: [  ],
              stdin: new Data_Maybe.Just(dhallCode)
          })(Node_ChildProcess.defaultSpawnOptions)))(function (v) {
              if (v instanceof Data_Either.Right && (v.value0.exit instanceof Node_ChildProcess.Normally && v.value0.exit.value0 === 0)) {
                  return new Data_Either.Right(v.value0.stdout);
              };
              if (v instanceof Data_Either.Right) {
                  return new Data_Either.Left([ v.value0.stderr ]);
              };
              if (v instanceof Data_Either.Left) {
                  return new Data_Either.Left([ "Command not found.", cmd ]);
              };
              throw new Error("Failed pattern match at Main (line 184, column 9 - line 187, column 57): " + [ v.constructor.name ]);
          }))(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Array.cons("dhallToJson"))));
      };
  };
  var decodeMap = function (decodeA) {
      return function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Expexted an object.")(Data_Argonaut_Core.toObject(json)))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable["for"](Data_Either.applicativeEither)(Data_Traversable.traversableArray)(Foreign_Object.keys(v))(function (key) {
                  return Data_Functor.mapFlipped(Data_Either.functorEither)(Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Expected key " + (tick(key) + "."))(Foreign_Object.lookup(key)(v)))(decodeA))(function (v1) {
                      return new Data_Tuple.Tuple(key, v1);
                  });
              }))(function (v1) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(v1));
              });
          });
      };
  };
  var decodeJsonSpagoConfig = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Expexted an object.")(Data_Argonaut_Core.toObject(json)))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("name"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonString))(v)("dependencies"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Expected key `packages`.")(Foreign_Object.lookup("packages")(v)))(decodeMap(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                      return "version";
                      ...
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonString))(v)("sources"))(function (v4) {
  ...
  var decodeJsonFromString = function (dictDecodeJson) {
      return Control_Bind.composeKleisli(Data_Either.bindEither)((function () {
          var $56 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)((function () {
              var $58 = Data_Array.cons("Invalid JSON");
              var $59 = Control_Applicative.pure(Control_Applicative.applicativeArray);
              return function ($60) {
                  return $58($59($60));
              };
          })());
          return function ($57) {
              return $56(Data_Argonaut_Parser.jsonParser($57));
          };
      })())((function () {
          var $61 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)((function () {
              var $64 = Data_Array.cons("Invalid Structure");
              var $65 = Control_Applicative.pure(Control_Applicative.applicativeArray);
              return function ($66) {
                  return $64($65($66));
              };
          })());
          var $62 = Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson);
          return function ($63) {
              return $61($62($63));
          };
      })());
  };
  var getSpagoConfig = function (config) {
      return Control_Monad_Except_Trans.withExceptT(Effect_Aff.functorAff)(Data_Array.cons("Read spago config at " + (tick(config.spagoConfig) + ".")))(Control_Monad_Except_Trans.mapExceptT(Data_Functor.map(Effect_Aff.functorAff)(Control_Bind.bindFlipped(Data_Either.bindEither)(decodeJsonFromString(decodeJsonSpagoConfig))))(dhallToJson(config.dhallToJson)("./" + config.spagoConfig)));
  };
  var run = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Apply.apply(Control_Monad_Except_Trans.applyExceptT(Effect_Aff.monadAff))(Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Effect_Aff.functorAff))(Record.union())(getCliArgs))(getEnv))(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(getSpagoConfig(v))(function (v1) {
          var nix = generateNix(v1);
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(writeTextFile(v.target)(printNixExpr(nix)))(function (v2) {
              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))(Data_Unit.unit);
          });
      });
  });
  var main = function __do() {
      var v = Data_Functor.mapFlipped(Effect.functorEffect)(Node_Process.getEnv)(parseEnvDebug)();
      return Effect_Aff.runAff_(function (v1) {
          if (v1 instanceof Data_Either.Left) {
              return function __do() {
                  Effect_Class_Console.error(Effect_Class.monadEffectEffect)(printErrorStack(nativeErrorToStack(v)(v1.value0)))();
                  return Node_Process.exit(1)();
              };
          };
          if (v1 instanceof Data_Either.Right && v1.value0 instanceof Data_Either.Left) {
              return function __do() {
                  Effect_Class_Console.error(Effect_Class.monadEffectEffect)(printErrorStack(v1.value0.value0))();
                  return Node_Process.exit(1)();
              };
          };
          ...
          throw new Error("Failed pattern match at Main (line 240, column 15 - line 247, column 37): " + [ v1.constructor.name ]);
      })(Control_Monad_Except_Trans.runExceptT(run))();
  };
  ...
  exports["parseEnvDebug"] = parseEnvDebug;
  exports["opts"] = opts;
  exports["SpagoConfig"] = SpagoConfig;
  exports["decodeMap"] = decodeMap;
  exports["printNixExpr"] = printNixExpr;
  exports["generateNix"] = generateNix;
  exports["getEnv"] = getEnv;
  exports["getCliArgs"] = getCliArgs;
  exports["dhallToJson"] = dhallToJson;
  exports["getSpagoConfig"] = getSpagoConfig;
  exports["writeTextFile"] = writeTextFile;
  exports["decodeJsonFromString"] = decodeJsonFromString;
  exports["printErrorStack"] = printErrorStack;
  exports["tick"] = tick;
  exports["nativeErrorToStack"] = nativeErrorToStack;
  exports["run"] = run;
  exports["main"] = main;
  exports["decodeJsonSpagoConfig"] = decodeJsonSpagoConfig;
})(PS);
PS["Main"].main();